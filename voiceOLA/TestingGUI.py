...
if __name__ == "__main__":
        ...
        # Lets make a dedicated thread for our voice Commands..
        #sb = SnowBoy()
        #vOLA = Thread(name='voiceOLA', target=sb.listener())
        #vOLA.setDaemon(True)
        #vOLA.start()
        #os.system('python snowBoyOLA.py > /de/null 2>&1 &')
        os.system('python snowBoyOLA.py  &')
	TestApp().run()
